...
class Genero(db.Model):
    ...
    # Definimos una relación con el modelo Libro
    # backref crea una relación inversa en el modelo Libro
    libros = db.relationship('Libro', backref='genero')
...
class Libro(db.Model):
    ...
    fecha_registro = db.Column(db.DateTime, default=datetime.utcnow)
    # Definimos una relación con el modelo Editorial
    # backref crea una relación inversa en el modelo Editorial
