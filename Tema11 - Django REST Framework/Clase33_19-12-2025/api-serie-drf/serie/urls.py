...
urlpatterns = [
    ...
    path('v1/favoritos/usuario/<int:pk>/', views.FavoritoUsuarioListView.as_view()),
    path('v1/favoritos/usuario/<int:pk>/<int:iduser>/', views.FavoritoUsuarioRetrieveView.as_view()),
    path('v1/favoritos/usuario/crear/', views.FavoritoUsuarioCreateView.as_view()),
    path('v1/favoritos/usuario/eliminar/<int:pk>/<int:iduser>/', views.FavoritoUsuarioDeleteView.as_view())
]